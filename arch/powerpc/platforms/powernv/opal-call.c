...
OPAL_CALL(opal_hca_socket_setup,		OPAL_HCA_SOCKET_SETUP);
OPAL_CALL(opal_hca_socket_reset,		OPAL_HCA_SOCKET_RESET);
OPAL_CALL(opal_hca_engine_setup,		OPAL_HCA_ENGINE_SETUP);
OPAL_CALL(opal_hca_engine_reset,		OPAL_HCA_ENGINE_RESET);
