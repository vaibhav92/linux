...
int opal_hca_chip_setup(struct opal_hca_chip_params *params);
int opal_hca_chip_reset(void);
int opal_hca_unit_setup(uint32_t unit, struct opal_hca_unit_params *params);
int opal_hca_unit_reset(uint32_t unit);
